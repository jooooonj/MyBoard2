package com.jj.myboard.base.rq;

import com.jj.myboard.SiteUser.SiteUser;
import com.jj.myboard.SiteUser.UserService;
import com.jj.myboard.base.rsData.RsData;
import com.jj.myboard.standard.util.Ut;
...
public class Rq {
    ...
    public SiteUser getUser() {
        ...
        // 데이터가 없는지 체크
        if (siteUser == null) {
            siteUser = userService.getUser(user.getUsername());
        }
